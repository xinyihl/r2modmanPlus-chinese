    ...
    <div class="game-card-wrapper">
        <div class="game-card">
            ...
            <div class="game-card__new-badge" v-if="isNew">
                <i class="fas fa-bolt game-card__new-badge-icon"></i> 新
            </div>
            <div class="game-card__overlay">
                ...
                <div class="game-card__overlay-body">
                    <button class="button is-info" @click="emit('select', game)">
                        选择此{{activeTab === GameInstanceType.GAME ? '游戏' : '服务器'}}
                    </button>
                    <button class="button" @click="emit('set-default', game)">设置为默认值</button>
                </div>
                <div class="game-card__overlay-spacer"></div>
            </div>
        </div>
