        ...
        <div class="activity-bar--left">
            ...
            <div class="activity-bar__group">
                <ActivityDropdown>
                    ...
                    <template #popper>
                        <ul class="menu-list">
                            <li><a v-close-popper @click="store.dispatch('profileExport/exportProfileAsCode')"><i class="fa fa-fw fa-code icon--margin-right"></i>导出为代码</a></li>
                            <li><a v-close-popper @click="store.dispatch('profileExport/exportProfileAsFile')"><i class="fa fa-fw fa-file-download icon--margin-right"></i>导出为文件</a></li>
                        </ul>
                    </template>
                </ActivityDropdown>
            </div>
