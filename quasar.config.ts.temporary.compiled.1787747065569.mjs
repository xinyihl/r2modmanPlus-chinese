...
var __quasar_inject_dirname__ = "E:\\project\\r2modmanPlus";
  ...
  return {
    ...
    build: {
      ...
      extendViteConf(viteConf) {
        ...
        viteConf.resolve.alias["@r2"] = path.resolve(__quasar_inject_dirname__, "src");
        if (ctx.dev) {
    ...
    devServer: {
      ...
      proxy: {
        ...
        "/_local": {
          ...
          changeOrigin: true,
          rewrite: (path2) => path2.replace(/^\/_local/, "")
        }
      }
    },
